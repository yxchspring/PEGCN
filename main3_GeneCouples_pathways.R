GeneCouples_pathways <- function(Data, WDEGs,classes_tumor,subtype_ii, pvalueCutoff=0.05,corr_cutoff=0.3,ifsetdiff=TRUE) {
  ...
  enrichGO_pathways.result <- enrichGO_pathways@result[which(enrichGO_pathways@result$pvalue<= pvalueCutoff),]
  ...
  enrichGO_pathways_sim_09.result <- enrichGO_pathways_sim_09@result[which(enrichGO_pathways_sim_09@result$pvalue <= pvalueCutoff),]
  ...
  Genecouples_pathways_experi <- Genecouples_pathways_experi[Genecouples_pathways_experi$pvalue <= pvalueCutoff,]
